...
int read_int(char *prompt, int def, int min, int max) {
	return (read_int(prompt, (char*) "", def, min, max));
}
...
long read_long(char *prompt, long def, long min, long max) {
	return (read_long(prompt, (char*) "", def, min, max));
}
...
//	max   : superior limit
//
double read_double(char *prompt, char *unit, double def, double min,
		double max) {
...
double read_double(char *prompt, double def, double min, double max) {
	return (read_double(prompt, (char*) "", def, min, max));
}
...
char* read_string(char *prompt) {
	return (read_string(prompt, (char*) ""));
}
